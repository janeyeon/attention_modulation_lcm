...
# for hierar_step in range(h_num):
    ...
    if hierar_step == 0:
        ...
        config.img2img_input_path = config.output_path  / f'global_{image_idx}_{config.seed}.png' # Later
    else:
        ...
        config.mix_ratio = 0.5
        config.reverse_ratio = 0.5
        config.img2img_input_path = config.output_path / f'group_{image_idx}_{config.seed}.png' # Later
