...
if __name__ == '__main__':
    ...
    with open("./group_dictionary_dic_llm_pred_s1_s2_filtered_422_total.json", "r") as st_json:
        group_dicts = json.load(st_json)

    # with open("./group_dictionary_dic.json", "r") as st_json:
    #     group_dicts = json.load(st_json)
    ...
    for hierar_step in range(2):
        ...
        if hierar_step == 1:
            image[0].save(f"./hicon_outputs/{image_idx}.png")
